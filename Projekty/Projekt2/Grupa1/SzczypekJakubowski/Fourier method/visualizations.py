...
##### THIS SCRIPT IS CREATED TO PROVIDE SOME VISUALIZATION FUNCTIONS FOR FOURIER SERIES
...
def create_close_loop(image_array, level=[200]):
    ...
    # get image contour
    contour_plot = ax[0].contour(image_array, levels=level, colors='black', origin='image')
